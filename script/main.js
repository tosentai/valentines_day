...
const messages = [
    "Натискай куди захочеш 🌸",  
    "Привіт, це я ❤️",  
    "Я маю для тебе щось особливе",  
    "Спробуй натиснути ще раз",  
    "Ну ж бо, ще разок 😘",  
    "Не здавайся, натискай далі!",  
    "Обіцяю, тепер точно останній раз 😉",  
    "Серйозно-серйозно!",  
    "Це",  
    "Останній…",  
    "Ой, обдурив 😅 Хехе, ще разок!",  
    "Мабуть, ти вже трохи злишся 😇",  
    "Хмм…",  
    "Гаразд, більше не буду жартувати!",  
    "Я просто хотів сказати…",  
    "Я тебе люблю! ❤️",  
    "Ух ти!",  
    "Натисни кнопку внизу, будь ласка 💝"
    ];    
